...
# MIT License
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/py/scripts/install_spacevim.py | sudo python3
# idempotent: safe to re-run
"""krun script: install_spacevim"""
