...
# MIT License
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/py/scripts/update_vagrant_box.py | sudo python3
# idempotent: safe to re-run
"""krun script: update_vagrant_box"""
