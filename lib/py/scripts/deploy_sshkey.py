...
# MIT License
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/py/scripts/deploy_sshkey.py | sudo python3
# idempotent: safe to re-run
"""krun script: deploy_sshkey"""
