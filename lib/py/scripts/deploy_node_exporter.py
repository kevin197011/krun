...
# MIT License
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/py/scripts/deploy_node_exporter.py | sudo python3
# idempotent: safe to re-run
"""krun script: deploy_node_exporter"""
