...
# MIT License
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/py/scripts/check_system_troubleshoot.py | sudo python3
# idempotent: safe to re-run
"""krun script: check_system_troubleshoot"""
...
SCRIPT = "check_system_troubleshoot"
