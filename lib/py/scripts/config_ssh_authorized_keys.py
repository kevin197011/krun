...
# MIT License
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/py/scripts/config_ssh_authorized_keys.py | sudo python3
# idempotent: safe to re-run
"""krun script: config_ssh_authorized_keys"""
...
SCRIPT = "config_ssh_authorized_keys"
