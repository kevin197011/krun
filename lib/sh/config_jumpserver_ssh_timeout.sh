...
#
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/config_jumpserver_ssh_timeout.sh | sudo bash

set -o errexit
set -o nounset
set -o pipefail

SCRIPT_PY="config_jumpserver_ssh_timeout"
