...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/update-vagrant_box.sh | bash
...
krun::update::vagrant_box::check_vagrant() {
    if ! command -v vagrant >/dev/null 2>&1; then
        ...
        echo "  curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-vagrant-virtualbox.sh | bash"
        return 1
    fi
