...
#
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-fonts-nerd-JetBrainsMono.sh | sudo bash

set -o errexit
set -o nounset
set -o pipefail

SCRIPT_PY="install_fonts_nerd_jetbrains"
