...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/config-proxy.sh | bash
# source (proxy applies in current shell):
# source <(curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/config-proxy.sh)
