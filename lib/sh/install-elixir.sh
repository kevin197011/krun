...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-elixir.sh | bash
...
krun::install::elixir::common() {
    ...
    if ! command -v asdf >/dev/null 2>&1; then
        ...
        curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-asdf.sh | bash
