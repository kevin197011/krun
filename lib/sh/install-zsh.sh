...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-zsh.sh | bash
...
EOF
    ...
    echo "   curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-oh_my_zsh.sh | bash"
    echo ""
