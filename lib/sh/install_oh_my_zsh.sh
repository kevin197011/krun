...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install_oh_my_zsh.sh | bash
...
krun::install::oh_my_zsh::common() {
    ...
    if ! command -v zsh >/dev/null 2>&1; then
        ...
        echo "  curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install_oh_my_zsh.sh | bash"
        return 1
    fi
