...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-ruby.sh | bash
...
krun::install::ruby::common() {
    ...
    if ! command -v asdf >/dev/null 2>&1; then
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install-asdf.sh | bash"
        return 1
    fi
