...
# curl exec:
# curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install_ruby.sh | bash
...
krun::install::ruby::common() {
    ...
    if ! command -v asdf >/dev/null 2>&1; then
        ...
        echo "curl -fsSL https://raw.githubusercontent.com/kevin197011/krun/main/lib/sh/install_ruby.sh | bash"
        return 1
    fi
